...
from tools.pdf_parser import parse_paper
from tools.vocabulary import extract_section_vocab, save_vocabulary
...
graph_builder.add_conditional_edges(
    "parse_paper", route_sections, ["extract_section_vocab"]
)
